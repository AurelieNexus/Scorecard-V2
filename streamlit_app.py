        ...
        if st.session_state.my_token_received:
            ...
            if lst:
                ...
                if not check_box:
                    ...
                    # enables pivoting on all columns, however i'd need to change ag grid to allow export of pivoted/grouped data; however, it selects/filters groups
